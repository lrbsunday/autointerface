...
def create_fields():
    ...
    fields = {
        ...
        "null": tools.get_params(request_info, 'null', need=True, vtype=bool),
        "unique": tools.get_params(request_info, 'unique', need=True, vtype=bool),
        "index": tools.get_params(request_info, 'index', need=True, vtype=bool),
